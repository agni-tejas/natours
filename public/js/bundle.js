...
var displayMap = exports.displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiYWduaXRlamFzIiwiYSI6ImNtMW0wZWg5MzBmeHAycnNsaWYwejdraGQifQ.DeSTRAdO4qjflt3S4fBjUQ';
  var map = new mapboxgl.Map({
    container: 'map',
    // container ID
    style: 'mapbox://styles/agnitejas/cm1m2sxge00iy01pe3dei6x0w',
    // style URL
    scrollZoom: false
...
function asyncGeneratorStep(n, t, e, r, o, a, c) { try { var i = n[a](c), u = i.value; } catch (n) { return void e(n); } i.done ? t(u) : Promise.resolve(u).then(r, o); }
function _asyncToGenerator(n) { return function () { var t = this, e = arguments; return new Promise(function (r, o) { var a = n.apply(t, e); function _next(n) { asyncGeneratorStep(a, r, o, _next, _throw, "next", n); } function _throw(n) { asyncGeneratorStep(a, r, o, _next, _throw, "throw", n); } _next(void 0); }); }; }
var stripe = Stripe('pk_test_51Q5tbMRxvse3eA1T5Tt5TY3cr6nRPPvTjprDOKQ49hHrgs2EcrAIYkeVc30TswcDjXsIQRgLK4KKRzsBiaG3MNSz00bjslcRLT');
...
if (bookBtn) bookBtn.addEventListener('click', function (e) {
  ...
  //when '-' is used in dataset tour-id becomes tourId
